...
#starting blocks below

# title block with sentered text
...
# Block for the links on the app
...
# card block with image in a image chooser block
...
# radio select for the image and text block to follow
